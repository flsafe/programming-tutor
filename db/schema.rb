...
ActiveRecord::Schema.define(:version => 20110318200927) do
  ...
  create_table "exercise_sets_users", :id => false, :force => true do |t|
  ...
  create_table "feed_back_comments", :force => true do |t|
    t.string   "email"
    t.string   "comment"
    t.datetime "created_at"
    t.datetime "updated_at"
