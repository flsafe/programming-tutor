Feature: Create Exercise
	...
	Scenario: The admin creates a new exercise
		...
		And I attach the file "test.png" to "Upload Figure"
		And I attach the file "remove-letter.c" to "Upload Solution Template"
		And I attach the file "remove-letter-unit-test.rb" to "Upload Unit Test"
